---
name: airi-image-upscale
description: 当用户明确要求将图片“提升分辨率”、“高清化”、“放大”、“变清晰”时使用。
---
...
| `baseImage` | 用户发送的图片或者指定的基图 | "https://airi-production.s3.cn-north-1.amazonaws.com.cn/base-image/371b8a1b-3e79-48a5-99e5-2d1db6cbd46e.jpg" |
...
- 技能位置：`~/.openclaw/skills/airi-image-extend`
