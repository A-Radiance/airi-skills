---
name: airi-image-gen
description: 当用户请求生成图片、设计图、效果图、插画、建筑概念图时，使用该技能，例如：
- “生成一张…”
- “设计一个…”
- “画一张…”
- “创建建筑概念图/插画/效果图”
...
```json
{
  ...
  "orientation": 0,
  "imageRatio": 0,
  "resolution-container": false,
  "styleReference-container": false,
  "privateModel-container": false,
  "workflowId": 0,
  "referenceImage": [],
  "additionalPrompt": "<用户描述>",
...
| `resolution-container` | Image prompt (Use the elements of an image) | false |
| `styleReference-container` | Style reference图片 | false |
| `privateModel-container` | Omni reference图片 | false |
| `projectId` | 填写上面获取到的projectId | - |
| `projectName` | 填写上面获取到的projectName | - |
| `referenceImage` | 用户发送的第1、2、3张图片或指定的，第1张是Image prompt，第2张是Style reference，第3张是Omni reference |
| [{"url":"https://airi-production.s3.cn-north-1.amazonaws.com.cn/base-image/371b8a1b-3e79-48a5-99e5-2d1db6cbd46e.jpg","type":0},{"weight":500,"url":"https://airi-production.s3.cn-north-1.amazonaws.com.cn/base-image/e1320e55-cafb-4664-a18f-c8636769cbfe.jpg","type":1},{"weight":400,"url":"https://airi-production.s3.cn-north-1.amazonaws.com.cn/base-image/a70d4d46-17e1-42e4-bc2f-aea71cbb5ddd.jpg","type":2}] |
...
| 参数 | 说明 | 可选值 |
|------|------|--------|
| `orientation` | 方向 | 0=横版, 1=竖版 |
| `imageRatio` | 一级分类 | 0=4:3，1=3:2，2=1:1，3=16:9，默认4:3 |
| `negativePrompt` | 负面提示词 | 任意文本 |
...
- 技能位置：`~/.openclaw/skills/airi-image-gen/`
